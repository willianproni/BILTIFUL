...
{
    public class RepositoryIdDAT<TEntity> where TEntity : EntidadeBase, IEntidadeDAT<TEntity>, new()
    {
        public List<TEntity> entities;
        public string Path { get; set; }

        public RepositoryIdDAT()
        {
            entities = GetAll();
        }
        public RepositoryIdDAT(string path) : this()
        {
            Path = path;
        }
        ...
        {
            return entities.Count != 0 ? (entities.Max(c => c.Id)) + 1 : 0;
        }
