...
namespace BILTIFUL.Core.Entidades
{
    public class Cliente
    {
        ...
        {
            return $"{CPF}{Nome.PadRight(50).Substring(49)}{DataNascimento.ToString("dd/MM/yyyy")}{(char)Sexo}{UltimaCompra.ToString("dd/MM/yyyy")}{DataCadastro.ToString("dd/MM/yyyy")}{(char)Situacao}";
        }
